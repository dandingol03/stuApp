        ...
        return (
            <View style={styles.container}>
                <View style={{ flex: 2, marginBottom: 0 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', padding: 25 }}>
                        <Ionicons name="md-arrow-back" size={30} color="#555" />
                    </View>


                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: width }}>
                        <Image source={require('../../img/school_log.jpg')} style={{ width: 200, height: 40 }}
                            resizeMode="stretch" />
                    </View>
